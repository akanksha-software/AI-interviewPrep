...
const Home = () => {
  ...
  const [activeSection, setActiveSection] = useState("interviewPrep");
    ...
    <div className="home-page">
      <div className="home-layout">
        <aside className="home-sidebar">
          <div className="home-sidebar__brand">AI Interview Prep</div>
          <nav className="home-sidebar__nav">
            <button
              className={`home-sidebar__item ${activeSection === "dashboard" ? "home-sidebar__item--active" : ""}`}
              onClick={() => {
            ...
            <button
              className={`home-sidebar__item ${activeSection === "interviewPrep" ? "home-sidebar__item--active" : ""}`}
              onClick={() => {
                setActiveSection("interviewPrep");
                navigate("/");
              }}
            >
              InterviewPrep
          ...
          {activeSection === "dashboard" && (
            <>
              <section className="dashboard-welcome">
                <div>
                  <p className="dashboard-welcome__eyebrow">Dashboard</p>
                  <h2>Hi {user?.name || "there"}!</h2>
                  <p>Here are your recent interview plans.</p>
                </div>
              </section>
              ...
              {reports.length > 0 ? (
                ...
                <section className="recent-reports recent-reports--empty">
                  ...
                  <p>Create your first interview plan to see it here.</p>
                </section>
              )}
            </>
          )}

          {activeSection === "interviewPrep" && (
            <>
